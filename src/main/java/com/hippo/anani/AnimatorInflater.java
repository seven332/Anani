...
public class AnimatorInflater {
    ...
    */
    ...
    private static Animator createAnimatorFromXml(Context context, XmlPullParser parser,
        ...
        while (((type = parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            if (name.equals("objectAnimator")) {
                ...
                PropertyValuesHolder[] values = loadValues(context, parser,
    ...
    /*
    private static PropertyValuesHolder[] loadValues(Context context, XmlPullParser parser,
        ...
        while ((type = parser.getEventType()) != XmlPullParser.END_TAG &&
            ...
            if (name.equals("propertyValuesHolder")) {
                TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PropertyValuesHolder);
                ...
                PropertyValuesHolder pvh = loadPvh(context, parser, propertyName, valueType);
                if (pvh == null) {
    ...
    */
    ...
    private static int inferValueTypeOfKeyframe(Context context, AttributeSet attrs) {
        int valueType;
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Keyframe);
    ...
    */
    ...
    private static PropertyValuesHolder loadPvh(Context context, XmlPullParser parser,
        ...
        while ((type = parser.next()) != XmlPullParser.END_TAG &&
            ...
            if (name.equals("keyframe")) {
                if (valueType == VALUE_TYPE_UNDEFINED) {
                    valueType = inferValueTypeOfKeyframe(context, Xml.asAttributeSet(parser));
                }
                Keyframe keyframe = loadKeyframe(context, Xml.asAttributeSet(parser), valueType);
                if (keyframe != null) {
                    if (keyframes == null) {
    ...
    */
    ...
    /*
    private static Keyframe loadKeyframe(Context context, AttributeSet attrs,
            int valueType)
            throws XmlPullParserException, IOException {
    ...
    */
    ...
    private static ValueAnimator loadAnimator(Context context, AttributeSet attrs,
        ...
        arrayAnimator = context.obtainStyledAttributes(attrs, R.styleable.Animator);

        // If anim is not null, then it is an object animator.
        if (anim != null) {
            arrayObjectAnimator = context.obtainStyledAttributes(attrs, R.styleable.PropertyAnimator);
        }
